...
const PrivacyContent = () => {
  const style = {
    wrapper:
      "w-[95%] md:w-[65%] lg:w-[50%] mx-auto font text-yellowDark py-5 md:py-12",
    mainHeading: "font-bold text-2xl md:text-3xl lg:text-3xl my-4 md:my-5",
    heading: "font-semibold text-xl md:text-2xl lg:text-2xl my-3 md:my-4",
  ...
  return (
    <div className={style.wrapper}>
      <p className={style.para}>
        Eler (“we” or “us” or “our”) respects the privacy of our users
